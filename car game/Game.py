...
# changing the logo
logo = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/logo.png")
...
def introImg(x, y):
    intro = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/intro.png")

    screen.blit(intro, (x, y))


def instructionIMG(x, y):
    instruct = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/instruction.png")
    run = True
    while run:
...
def aboutIMG(x, y):
    aboutimg = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/About.png")
    run = True
    while run:
...
def introscreen():
    run = True
    pygame.mixer.music.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/startingMusic.mp3")
...
def countdown():
    ...
    countdownBacground = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/bg.png")
...
def gameloop():
    ####### music #######
    pygame.mixer.music.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/BackgroundMusic.mp3")
    pygame.mixer.music.play()
    ###### sound effect for collision ######
    crash_sound = pygame.mixer.Sound("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/car_crash.wav")
    ...
    # highscore part
    with open("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/highscore.txt", "r") as f:
        highscore = f.read()
    ...
    def gameover():
        gameoverImg = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/gameover.png")
        run = True
        while run:
    ...
    bg = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/bg.png")

    # setting our player
    maincar = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/main car.png")
    maincarX = 350
    maincarY = 495
    maincarX_change = 0
    maincarY_change = 0
    ...
    # other cars
    car1 = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/car 1.png")
    car1X = random.randint(178, 490)
    car1Y = 100
    car1Ychange = 10
    car2 = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/car 2.png")
    car2X = random.randint(178, 490)
    car2Y = 100
    car2Ychange = 10

    car3 = pygame.image.load("C:/Users/chirag/OneDrive/Desktop/python/python-beginner-projects/projects/car game/car 3.png")
